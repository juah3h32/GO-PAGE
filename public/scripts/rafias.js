...
const productData = [
  {
    name: "RAFIA FIBRILADA T1",
    description: "Rafia Polipropileno 100% virgen. Alta resistencia e inalterable a la intemperie. Uso agrícola, industrial y empaque. Opción UV y colores. Ideal fábricas, bodegas, abastos y ferreterías",
    specs: { load: "939 m", diam: "1", mat: "PP-V", elong: "21 kg", grip: "390 KG", loadResist: "Excelente" },
    bg: "var(--bg-cuerda)"
  },
  {
    name: "RAFIA FIBRILADA ECO",
    description: "Rafia de Polipropileno: gran resistencia y rendimiento. Ideal uso agrícola, industrial, ferretero y empaque. Soporta intemperie, opción filtro UV. Varios colores. Perfecta para bodegas y fábricas",
    specs: { load: "3,240 m", diam: "1", mat: "PP-UV", elong: "18 kg", grip: "105 kg", loadResist: "Excelente" },
    bg: "var(--bg-strech)"
  },
  {
    name: "RAFIA FIBRILADA T2",
    description: "Rafia de Polipropileno: gran resistencia y rendimiento. Inalterable a intemperie, opción UV. Colores. Uso agrícola, avícola, industrial, empaque. Ideal bodegas, ferreterías, abastos y talleres.",
